...
\usepackage[
    ...
    bibstyle=numeric,   % style pour les clés des références dans la bibliographie : [initialesAnnée]
    citestyle=numeric,  % style pour les clés des références dans le texte : [initialesAnnée]
