...
\hypersetup{
    ...
    urlcolor=black,
    hyperfigures = true % Ajouter liens table des matières vers les parties lors du clic
}
...
\usepackage[
    ...
    backend=bibtex,
    babel=hyphen, % Environnement linguistique dédié aux entrées en langues alternatives
